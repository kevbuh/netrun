...
export const DEFAULT_ANNOTATION_PROMPT =
  ...
  "Annotation types:\n" +
  "- INSIGHT — Something lowkey, an uncommon or surprising result or fact. The thing worth remembering. Only use for genuinely informative information.\n" +
  ...
  "- FACTCHECK — a claim that needs citation or verification. Flag statements presented as facts that lack sources, especially statistics, dates, or causal claims.\n" +
  "- EVIDENCE — a passage where data, examples, or sources would strengthen the argument. Flag assertions that would benefit from supporting evidence.\n\n" +
  ...
  '- "explanation": 1-2 sentences. For INSIGHT: why this matters. For CONTRADICTION: what it contradicts and why. For EXAGGERATION: what\'s overstated and what the evidence actually supports. For AD: what\'s being sold. For FACTCHECK: what claim needs verification. For EVIDENCE: what evidence would strengthen this.\n' +
