...
function _renderPanelSettings() {
  ...
  const annotateModel = localStorage.getItem('annotateModel') || 'qwen2.5:7b';
  ...
  return `
    ...
    <div class="mb-8 pt-5 border-t border-border-subtle">
      ...
      <select data-key="annotateModel" data-fallback="qwen2.5:7b" onchange="localStorage.setItem('annotateModel', this.value)" class="settings-model-select w-full max-w-[320px] px-3 py-1.5 rounded-md text-[0.8rem] border border-border-input bg-card text-primary outline-none focus:border-accent cursor-pointer">
