...
export { _getActiveTabBar, _pillSyncTabs } from '/js/toolbar/toolbar-tabs.js';
export { _setPillBrowseMode, _togglePillMenu, _closePillMenu } from '/js/toolbar/toolbar-island.js';
