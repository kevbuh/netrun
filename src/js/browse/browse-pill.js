...
function _populatePillMenuMoreItems() {
  ...
  html += '<button onclick="browseSaveToReadingList();_populatePillMenuMoreItems()"><svg class="w-4 h-4" viewBox="0 0 24 24" fill="' + (isSaved ? 'var(--accent)' : 'none') + '" stroke="' + (isSaved ? 'var(--accent)' : 'currentColor') + '" stroke-width="2"><path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z"/></svg> ' + (isSaved ? 'Saved' : 'Save to Reading List') + '</button>';
